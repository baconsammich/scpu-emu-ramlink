...
// The RAMCard image, and the temporary it is written through. The save is
// never done in place: see writeFileAtomic().
#define SCPU_RAMLINK_IMG    "SD:SCPU/ramlink.img"
#define SCPU_RAMLINK_TMP    "SD:SCPU/ramlink.tmp"
